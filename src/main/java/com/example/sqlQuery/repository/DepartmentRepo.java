...
public interface DepartmentRepo extends JpaRepository<Department,Long> {
    ...
    @Query("SELECT new com.example.sqlQuery.dto.StudentDepartmentDto(d.name,s.name) FROM Department d JOIN d.teachers t JOIN t.courses c JOIN c.students s")
    List<StudentDepartmentDto> getGetDepartmentStudentEntrolledCourse();
}
